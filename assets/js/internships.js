document.addEventListener('DOMContentLoaded', () => {
  ...
  function determineRoleCategory(title) {
    ...
    else if (lowerTitle.includes('data sci') || 
    ...
    else if (lowerTitle.includes('machine') || 
    ...
    else if (lowerTitle.includes('cyber') || 
    ...
    .then(data => {
      ...
      allInternships = data
        ...
        .map(item => {
          ...
          const roleCategory = determineRoleCategory(item.title || item.job_title || '');
      ...
      console.log('Processed internships:', allInternships.length, 'entries ready to display');
